...
class ViewController: UIViewController {
    ...
    @IBAction func passBackToQb(_ sender: Any) {
        print("passing text to qb");
        if textToPass.text == "" {
        ...
        let urlPass: String = "passBackText://" + self.textToPass.text!.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!
